...
[![docker-sshd](https://github.com/bensuperpc/docker-sshd/actions/workflows/main.yml/badge.svg?branch=main)](https://github.com/bensuperpc/docker-sshd/actions/workflows/main.yml) [![tagged-release](https://github.com/bensuperpc/docker-sshd/actions/workflows/release.yml/badge.svg?branch=main)](https://github.com/bensuperpc/docker-sshd/actions/workflows/release.yml) ![GitHub Release Date](https://img.shields.io/github/release-date/bensuperpc/docker-sshd)
...
```
$ docker run --rm -it --entrypoint /usr/bin/env docker.io/bensuperpc/sshd:v1.5.0 mkpasswd
Password:
...
docker run -ti -p 2222:22 \
  ...
  docker.io/bensuperpc/sshd:v1.5.0
```
...
See the [releases](https://github.com/bensuperpc/docker-sshd/releases) for tag usage
and release notes.
...
### Infos
Fork from the git repository of: https://github.com/panubo/docker-sshd